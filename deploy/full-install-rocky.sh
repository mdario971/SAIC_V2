#!/bin/bash
# Strudel AI - Complete Rocky Linux 9 Installation Script
...
echo "╔════════════════════════════════════════════════════════════╗"
echo "║   Strudel AI - Rocky Linux 9 Installation Script          ║"
echo "╚════════════════════════════════════════════════════════════╝"
...
echo "[10/10] Configuring Nginx and Firewall..."

# SELinux - allow nginx to connect to network
setsebool -P httpd_can_network_connect 1

cat > /etc/nginx/conf.d/strudel-ai.conf << 'NGINXCFG'
server {
    listen 80;
    server_name _;
